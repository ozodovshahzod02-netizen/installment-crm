...
public class UpdateInstallmentContractCommandValidator
    : AbstractValidator<UpdateInstallmentContractCommand>
{
    public UpdateInstallmentContractCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
